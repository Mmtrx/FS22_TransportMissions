...
function RoyalMod.new(debug, mpSync)
	...
	TypeManager.validateTypes = function(self, ...)
		--[[ -- doesn't work since FS22. no more access to gameEnv
		---@type table<string, string>
		local global = mod.gameEnv["g_i18n"].texts
		---@type string
		for key, text in pairs(g_i18n.texts) do
			if global[key] == nil then global[key] = text end
		end
		]]
		if mod.initialize ~= nil then
			--- g_currentMission is still nil here. Attention: validateTypes this will be called twice:
